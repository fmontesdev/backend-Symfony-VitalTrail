...
use App\Sessions\Application\UseCase\Query\GetActiveSession\GetActiveSessionQuery;
 ...
 */
final class ActiveSessionProvider implements ProviderInterface
{
    ...
    public function provide(Operation $operation, array $uriVariables = [], array $context = []): SessionResource
    {
        ...
        $result->session = $this->service->handle(new GetActiveSessionQuery());
