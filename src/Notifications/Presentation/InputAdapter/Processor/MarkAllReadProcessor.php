...
use App\Notifications\Application\UseCase\Command\MarkAllNotificationsRead\MarkAllNotificationsReadCommand;
 ...
 */
final class MarkAllReadProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): null
    {
        ...
        $this->service->handle(new MarkAllNotificationsReadCommand($userId));
